            ...
            <div v-if="!sent">
              <div class="mb-4">
                ...
                <div class="pixel-input-wrap">
                  <input v-model="form.name" type="text" class="pixel-input" :class="{ error: errors.name }" placeholder="Tu nombre aquí..." />
                </div>
              ...
              <div class="mb-4">
                ...
                <div class="pixel-input-wrap">
                  <input v-model="form.email" type="email" class="pixel-input" :class="{ error: errors.email }" placeholder="tu@email.com" />
                </div>
              ...
              <div class="mb-4">
                ...
                <div class="pixel-input-wrap">
                  <textarea v-model="form.message" class="pixel-input" :class="{ error: errors.message }" rows="5" placeholder="Describe tu misión aquí..."></textarea>
                </div>
              ...
              <button class="pixel-btn w-100 submit-btn" @click="submitForm" :disabled="loading">
...
export default {
  ...
  setup() {
    ...
    return { hero, form, errors, sent, loading, loadingDots, contactItems, submitForm }
  },
}
</script>
